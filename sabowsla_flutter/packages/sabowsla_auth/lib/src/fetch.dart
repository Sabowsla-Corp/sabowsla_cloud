...
import 'package:sabowsla_auth/src/types/auth_exception.dart';
import 'package:sabowsla_auth/src/types/fetch_options.dart';

enum RequestMethodType { get, post, put, delete }

class SabowslaAuthFetch {
  final Client? httpClient;

  const SabowslaAuthFetch([this.httpClient]);
  ...
  Future<dynamic> request(
    ...
    SabowslaAuthRequestOptions? options,
  }) async {
