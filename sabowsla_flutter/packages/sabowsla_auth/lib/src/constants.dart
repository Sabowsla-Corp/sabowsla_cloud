...
import 'package:sabowsla_auth/src/version.dart';

class Constants {
  static const String defaultSabowslaAuthUrl = 'http://localhost:1203';
  static const String defaultAudience = '';
  static const Map<String, String> defaultHeaders = {
    'X-Client-Info': 'sabowsla-auth-dart/$version',
  };
  static const int defaultExpiryMargin = 60 * 1000;

  /// storage key prefix to store code verifiers
  static const String defaultStorageKey = 'sabowsla.auth.token';
