...
void main() {
  late SabowslaStorageClient storage;
  ...
  setUp(() async {
    ...
    storage = SabowslaStorageClient(storageUrl, {
  ...
  group('Transformations', () {
    ...
    test('will return the image as webp when the browser support it', () async {
      final storage = SabowslaStorageClient(storageUrl,
  ...
  group('file operations', () {
    test('copy', () async {
      final storage = SabowslaStorageClient(
