...
import 'package:sabowsla_realtime/src/push.dart';
import 'package:sabowsla_realtime/src/retry_timer.dart';
import 'package:sabowsla_realtime/src/transformers.dart';
import 'package:sabowsla_realtime/src/types.dart';
...
class RealtimeChannel {
  ...
  ///
  /// [timeout] parameter can be used to override the default timeout set on [SabowslaRealtime].
  ...
  /// Sets up a listener on your Sabowsla database.
  ///
  ...
  ///
  /// ```dart
  /// sabowsla.channel('my_channel').onPostgresChanges(
  ...
  ///
  /// ```dart
  /// sabowsla.channel('my_channel').onBroadcast(
  ///     event: 'position',
  ///     callback: (payload) {
  ///       print(payload);
  ///     }).subscribe();
  ...
  ///
  /// ```dart
  /// final channel = sabowsla.channel('my_channel');
  /// channel
  ///     .onPresenceSync(
